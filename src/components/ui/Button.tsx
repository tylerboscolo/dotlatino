...
export default function Button({
  ...
  const variants = {
    primary: 'bg-gradient-to-br from-gold to-orange text-neutral-black hover:brightness-110 hover:-translate-y-0.5 hover:shadow-[0_8px_30px_rgba(212,168,67,0.3)] active:translate-y-0 active:brightness-95',
